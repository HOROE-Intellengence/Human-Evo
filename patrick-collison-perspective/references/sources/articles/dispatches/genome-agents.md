<!-- source: https://patrickcollison.com/dispatches/genome-agents -->
<!-- fetched: 2026-08-27 -->
<!-- fidelity: verbatim via chrome get_page_text -->

Title: Genome Agents · Patrick Collison
URL: https://patrickcollison.com/dispatches/genome-agents

Genome Agents
2026-04-17 · X post · all dispatches
...
Population averages are population averages, but we ourselves are not averages. For example, it turns out that I probably have a 30x(!) higher-than-average predisposition to melanoma. It turns out that there are both specific supplements that help counteract the particular mutations I have, and of course I can significantly dial up my screening frequency. So, this is very useful to know.
