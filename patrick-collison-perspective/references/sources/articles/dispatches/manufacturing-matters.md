<!-- source: https://patrickcollison.com/dispatches/manufacturing-matters -->
<!-- fetched: 2026-08-27 -->
<!-- fidelity: verbatim via chrome get_page_text -->

Title: Manufacturing Matters · Patrick Collison
URL: https://patrickcollison.com/dispatches/manufacturing-matters

Manufacturing Matters
2025-09-21 · X post · all dispatches

A recent reflection, based on conversations with policy leaders, is that there are two superficially similar but importantly different perspectives one can hold with respect to US manufacturing:
